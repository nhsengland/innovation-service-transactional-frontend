...
const stepsLabels: InnovationSectionStepLabels = {
  ...
  q4: { label: 'What are the benefits or impact of your innovation?' },
  q5: { label: 'Does your innovation impact a disease or condition?' },
  q6: {
      ...
      parameters: [
        {
          ...
          description: stepsLabels.q7.description,
          validations: { isRequired: [true, 'Choose one option'] },
        ...
        parameters: [
          {
            ...
            dataType: 'textarea',
            label: data.estimatedCarbonReductionSavings === 'YES' ? stepsLabels.q8_a.label : stepsLabels.q8_b.label,
            validations: { isRequired: [true, 'A description is required'] },
            lengthLimit: 'xl'
          }
        ]
...
function outboundParsing(data: StepPayloadType): OutboundPayloadType {
  return {
    ...
    ...(data.hasProductServiceOrPrototype && { hasProductServiceOrPrototype: data.hasProductServiceOrPrototype }),
...
function summaryParsing(data: StepPayloadType): WizardSummaryType[] {
  ...
  toReturn.push(
    ...
    {
      label: stepsLabels.q3.label,
      value: yesNoItems.find(item => item.value === data.hasProductServiceOrPrototype)?.label,
      editStepNumber: editStepNumber++
    },
    {
      label: stepsLabels.q4.label,
