...
const stepsLabels = {
  ...
  q2: {
    ...
    description: `
      <p>If this is or might be a medical device, include the <a href="https://www.digitalregulations.innovation.nhs.uk/developers-guidance/all-developers-guidance/medical-devices-intended-purpose-statement" target="_blank" rel="noopener noreferrer">intended purpose statement (opens in a new tab)</a>.</p>
  ...
  q6: {
    ...
    description: `
    <p>All NHS suppliers will be expected to provide the carbon footprint associated with the use of their innovation, as outlined in the <a href="https://www.england.nhs.uk/greenernhs/wp-content/uploads/sites/51/2022/07/B1728-delivering-a-net-zero-nhs-july-2022.pdf" target="_blank" rel="noopener noreferrer">Delivering a Net Zero NHS report (opens in a new tab)</a>.</p>
  ...
  q8: {
    ...
    description: `All NHS suppliers will require a carbon reduction plan (CRP), as outlined in the <a href="https://www.england.nhs.uk/greenernhs/get-involved/suppliers/" target="_blank" rel="noopener noreferrer">NHS Suppliers Roadmap plan (opens in a new tab)</a>.`
  },
  q9: {
    ...
    <p>More information is available on the <a href="https://www.england.nhs.uk/about/equality/equality-hub/national-healthcare-inequalities-improvement-programme/core20plus5" target="_blank" rel="noopener noreferrer">Core20PLUS5 web page (opens in a new tab)</a>.</p>`
  },
  q10: {
    ...
    description: `
      ...
      <p>One example is the Equality Impact Assessment Standard produced by the <a href="https://www.nhsrho.org" target="_blank" rel="noopener noreferrer">NHS Race and Health Observatory (opens in a new tab)</a>.</p>`
  },
  q11: {
