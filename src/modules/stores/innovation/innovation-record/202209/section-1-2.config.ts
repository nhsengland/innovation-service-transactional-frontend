...
// Types.
type StepPayloadType = DocumentType202209['VALUE_PROPOSITION'];

export const SECTION_1_2: InnovationSectionConfigType<InnovationSections> = {
        ...
        parameters: [
          {
            ...
            description:
              "This is a simple statement that summarises your innovation, shows how it's different and documents the value that it brings to the customer.",
      ...
      parameters: [
        {
          ...
          description:
            'Example problem description:<br />The process of checking a patient’s pulse to determine if there is atrial fibrillation using a finger and a watch is inherently inaccurate.',
      ...
      parameters: [
        {
          ...
          description:
            'Describe your improvement. What will happen differently? How might that lead to a reduction of the consequences of the problem?',
      ...
      parameters: [
        {
          ...
          description:
            'Example impact description:<br />A 20% reduction in emergency referrals from care homes to the Emergency Department. For a mid-sized Integrated Care System (ICS) covering a population of 250,000, this would equate to 150-200 referrals per year.',
