        ...
        parameters: [
          {
            ...
            description:
              'What we mean by market research is information gathering via different methodologies to understand the user need for your innovation. For example, in-depth interview, focus groups, telephone interviews, online surveys, Patient Record Forms (PRFs).',
