        ...
        parameters: [
          {
            ...
            description:
              "This means mapping out the entire patient journey and the work done in different parts of the healthcare system. It's also key to understand the existing routines of clinical and care professionals, administrators, and anyone else who will be affected by your innovation.",
      ...
      parameters: [
        {
          ...
          description:
            'Please focus on any areas that will be impacted by introducing your innovation to the care pathway.',
