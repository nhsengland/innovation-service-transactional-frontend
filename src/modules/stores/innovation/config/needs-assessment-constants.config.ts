...
export const NEEDS_ASSESSMENT_QUESTIONS: {
  ...
  innovation: [
    new FormEngineParameterModel({
      ...
      description:
        'Consider if anything provided by the innovator needs clarification, such as the innovation category or company location.',
    ...
    new FormEngineParameterModel({
      ...
      additional: [
        new FormEngineParameterModel({
          id: 'hasRegulatoryApprovalsComment',
          dataType: 'textarea',
          label: '',
          lengthLimit: 'xs',
          description: 'Message (optional)'
  ...
  innovator: [
    new FormEngineParameterModel({
      ...
      description:
        'This should be founded on a understanding of the value of the product to NHS patients, staff, services and organisations, gained through detailed market research',
      validations: { isRequired: [true, 'Choose one option'] },
      items: yesPartiallyNoItems,
      additional: [
        new FormEngineParameterModel({
          id: 'hasPropositionComment',
          dataType: 'textarea',
          label: '',
          lengthLimit: 'xs',
          description: 'Message (optional)'
    ...
    new FormEngineParameterModel({
      ...
      additional: [
        new FormEngineParameterModel({
          id: 'hasCompetitionKnowledgeComment',
          dataType: 'textarea',
          label: '',
          lengthLimit: 'xs',
          description: 'Message (optional)'
    ...
    new FormEngineParameterModel({
      ...
      description:
        'An implementation plan should consider things like customer job roles affected, pathway redesign, route to reach market, understanding of the complexity and change management required.',
      validations: { isRequired: [true, 'Choose one option'] },
      items: yesPartiallyNoItems,
      additional: [
        new FormEngineParameterModel({
          id: 'hasImplementationPlanComment',
          dataType: 'textarea',
          label: '',
          lengthLimit: 'xs',
          description: 'Message (optional)'
