...
export class ContextStore extends Store<ContextModel> {
  ...
  dismissNotification(innovationId: string, conditions: { notificationIds?: string[], contextTypes?: NotificationCategoryEnum[], contextDetails?: NotificationContextDetailEnum[], contextIds?: string[] }): void {
