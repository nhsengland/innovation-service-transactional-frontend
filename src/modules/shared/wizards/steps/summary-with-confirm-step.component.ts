...
export class WizardSummaryWithConfirmStepComponent
  extends CoreComponent
  implements WizardStepComponentType<SummaryWithConfirmStepInputType, SummaryWithConfirmStepOutputType>, OnInit
{
  @Input() title = '';
