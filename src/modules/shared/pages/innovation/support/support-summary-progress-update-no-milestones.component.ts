...
import {
  OutboundPayloadType,
  SUPPORT_SUMMARY_NO_MILESTONES_PROGRESS_UPDATE
} from './support-summary-progress-update-no-milestones.config';

@Component({
  selector: 'shared-pages-innovation-support-support-summary-progress-update-no-milestones',
  templateUrl: './support-summary-progress-update-no-milestones.component.html'
})
export class PageInnovationSupportSummaryProgressUpdateNoMilestonesComponent extends CoreComponent implements OnInit {
  @ViewChild(FormEngineComponent) formEngineComponent?: FormEngineComponent;

  innovationId: string;
  baseUrl: string;

  wizard = new WizardEngineModel(SUPPORT_SUMMARY_NO_MILESTONES_PROGRESS_UPDATE);
