...
import { SUPPORT_SUMMARY_MILESTONES_ARRAYS } from './wizard-support-summary-progress-update-milestones/constants';
...
export class PageInnovationSupportSummaryProgressUpdateComponent extends CoreComponent {
  ...
  constructor() {
    ...
    this.userOrgHasMilestones = Object.keys(SUPPORT_SUMMARY_MILESTONES_ARRAYS).includes(
