...
import { INNOVATION_SECTION_STATUS, InnovationAllSectionsInfoDTO, SectionsSummaryModel } from "@modules/stores/innovation/innovation.models";
      ...
      .subscribe(
        ([sectionsResponse, documentsResponse, summary]) => {
          ...
          for (const curSection of allSections) {
            const responseItem: InnovationAllSectionsInfoDTO[number] = sectionsResponse.find(s => s.section.section === curSection.value) ?? {
              data: {},
