...
import { PageInnovationMessagesEditComponent } from './messages-edit.component';


describe('Shared/Pages/Innovation/Messages/PageInnovationMessagesEditComponent', () => {

  let activatedRoute: ActivatedRoute;

  let innovationStore: InnovationStore;

  let component: PageInnovationMessagesEditComponent;
  let fixture: ComponentFixture<PageInnovationMessagesEditComponent>;
  ...
  it('should create the component', () => {
    ...
    fixture = TestBed.createComponent(PageInnovationMessagesEditComponent);
