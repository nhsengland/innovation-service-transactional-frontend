...
import { PageInnovationThreadsListComponent } from './threads-list.component';


describe('Shared/Pages/Innovation/Messages/PageInnovationThreadsListComponent', () => {

  let activatedRoute: ActivatedRoute;

  let innovationStore: InnovationStore;

  let component: PageInnovationThreadsListComponent;
  let fixture: ComponentFixture<PageInnovationThreadsListComponent>;
  ...
  it('should create the component', () => {
    ...
    fixture = TestBed.createComponent(PageInnovationThreadsListComponent);
