...
import { PageInnovationCommentsListComponent } from './comments-list.component';


describe('Shared/Pages/Innovation/CommentsPageInnovationCommentsListComponent', () => {

  let activatedRoute: ActivatedRoute;

  let innovationStore: InnovationStore;

  let component: PageInnovationCommentsListComponent;
  let fixture: ComponentFixture<PageInnovationCommentsListComponent>;
  ...
  it('should NOT reply to a comment with API error', () => {
    ...
    const expected = { type: 'error', title: 'An error occured when creating an action', message: 'Please, try again or contact us for further help' };
