  ...
  private getTaskInfo() {
    ...
    this.innovationsService.getTaskInfo(this.innovationId, this.taskId).subscribe(response => {
      ...
      if (this.isInnovatorType) {
        ...
        this.stores.context.dismissNotification(this.innovationId, { contextDetails: [NotificationContextDetailEnum.TA03_TASK_DONE_TO_ACCESSOR_OR_ASSESSMENT], contextIds: [this.task.id] });
      }
