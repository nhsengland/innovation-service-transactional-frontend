...
import { Filter } from '@modules/core/models/filters/filters.model';
...
export const InnovationsListFiltersConfig: Filter[] = [
  {
    type: 'CHECKBOXES',
    key: 'checkboxes',
    checkboxes: [
...
const InnovationListDatasets: Record<string, { label: string; value: string }[]> = {
...
export function getConfig(role?: UserRoleEnum): {
  filters: Filter[];
  datasets: Record<string, { label: string; value: string }[]>;
} {
  ...
  return { filters: filtersConfig, datasets };
}
