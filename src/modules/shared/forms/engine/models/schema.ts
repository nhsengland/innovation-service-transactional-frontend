import { InnovationRecordSchemaV3Type } from '@modules/stores/innovation/innovation-record/202405/ir-v3-types';

export const IR_SCHEMA: InnovationRecordSchemaV3Type = {
  sections: [
    {
          ...
          steps: [
            ...
            },
            {
              questions: [
                {
                  id: 'evidences',
                  dataType: 'evidence-step',
                  label: 'Evidences',
                  description: 'Add evidences that support your innovation',
                  validations: {
                    isRequired: 'Must add at least one evidence'
                  }
                }
              ],
              condition: {
