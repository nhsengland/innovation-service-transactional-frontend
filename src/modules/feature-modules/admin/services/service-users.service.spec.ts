...
describe('FeatureModules/Admin/Services/ServiceUsersService', () => {
  ...
  it('should run getUserFullInfo() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.getUserFullInfo('_user01').subscribe(success => response = success, error => response = error);
  ...
  it('should run getLockUserRules() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.getLockUserRules('_user01').subscribe(success => response = success, error => response = error);
  ...
  it('should run lockUser() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.lockUser('_user01', { id: 'slsId', code: 'slsCode' }).subscribe(success => response = success, error => response = error);
  ...
  it('should run lockUser() and return ERROR, returning SLS object ID', () => {
    ...
    let response: any = null;
    service.lockUser('_user01', { id: '', code: '' }).subscribe(success => response = success, error => response = error);
  ...
  it('should run unlockUser() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.unlockUser('_user01', { id: 'slsId', code: 'slsCode' }).subscribe(success => response = success, error => response = error);
  ...
  it('should run unlockUser() and return ERROR, returning SLS object ID', () => {
    ...
    let response: any = null;
    service.unlockUser('_user01', { id: '', code: '' }).subscribe(success => response = success, error => response = error);
  ...
  it('should run createUser() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.createUser({}, { id: 'slsId', code: 'slsCode' }).subscribe(success => response = success, error => response = error);
  ...
  it('should run createUser() and return ERROR, returning SLS object ID', () => {
    ...
    let response: any = null;
    service.createUser({}, { id: '', code: '' }).subscribe(success => response = success, error => response = error);
  ...
  it('should run deleteAdminAccount() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.deleteAdminAccount('_user01', { id: 'slsId', code: 'slsCode' }).subscribe(success => response = success, error => response = error);
  ...
  it('should run deleteAdminAccount() and return ERROR, returning SLS object ID', () => {
    ...
    let response: any = null;
    service.deleteAdminAccount('_user01', { id: '', code: '' }).subscribe(success => response = success, error => response = error);
  ...
  it('should run searchUser() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.searchUser('some@email.com', true).subscribe(success => response = success, error => response = error);
  ...
  it('should run getUserRoleRules() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.getUserRoleRules('_user01').subscribe(success => response = success, error => response = error);
  ...
  it('should run changeUserRole() and return SUCCESS', () => {
    ...
    }).subscribe(success => response = success, error => response = error);
  ...
  it('should run changeOrganisationUserUnit() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.changeOrganisationUserUnit({}, { id: 'slsId', code: 'slsCode' }, '_user01').subscribe(success => response = success, error => response = error);
  ...
  it('should run changeOrganisationUserUnit() and return ERROR, returning SLS object ID', () => {
    ...
    let response: any = null;
    service.changeOrganisationUserUnit({}, { id: '', code: '' }, '_user01').subscribe(success => response = success, error => response = error);
  ...
  it('should run getOrgnisationUnitRules() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.getOrgnisationUnitRules('_user01').subscribe(success => response = success, error => response = error);
  ...
  it('should run getListOfTerms() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.getListOfTerms(tableList.getAPIQueryParams()).subscribe(success => response = success, error => response = error);
  ...
  it('should run createVersion() and return SUCCESS', () => {
    ...
    let response: any = null;
    service.createVersion({}).subscribe(success => response = success, error => response = error);
