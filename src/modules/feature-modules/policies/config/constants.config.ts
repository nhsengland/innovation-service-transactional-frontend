  ...
  necessary: [
    {
      ...
      expires: 'When you close the browser (if you do not use the banner) or 1 year (if you use the banner).'
    },
    {
      name: 'grav-site',
      purpose:
    ...
    },
    {
      name: 'connect.sid',
      purpose:
        'Innovation Service session cookie. This is set when you log in to the service. It makes temporary use of your personal information previously collected by us, only holding information for the duration of your session. It is required by various features in the site and is deleted when your session ends.',
      expires: 'Session'
    },
    {
      name: 'ApplicationGatewayAffinity',
      purpose: 'This cookie is provided by the load balancer and used to ensure functionality of the service.',
      expires: 'Session'
    },
    {
      name: 'ApplicationGatewayAffinityCORS',
      purpose:
        'This cookie is provided by the load balancer and used to ensure functionality of the service, even for cross-origin requests.',
      expires: 'Session'
    }
  ],
