...
describe('FeatureModules/Accessor/AccessorLayoutComponent', () => {
  ...
  it('should have notifications', () => {
    ...
    notificationsService.getAllUnreadNotificationsGroupedByContext = () =>
      of({ INNOVATION: 1 });
  ...
  it('should have leftSideBar with no values', () => {
    activatedRoute.snapshot.data = {
      layoutOptions: { backLink: { url: '/', label: 'Go back' } },
    };
    authenticationStore.isValidUser = () => true;
  ...
  it('should have leftSideBar with "userAccountMenu" menu values', () => {
    activatedRoute.snapshot.data = {
      layoutOptions: { type: 'userAccountMenu' },
    };
  ...
  it('should have leftSideBar with "innovationLeftAsideMenu" menu values', () => {
    ...
    activatedRoute.snapshot.data = {
      layoutOptions: { type: 'innovationLeftAsideMenu' },
    };

    const expected = [
      {
        title: 'Overview',
        link: `/accessor/innovations/innovation01/overview`,
      },
      {
        title: 'Innovation record',
        link: `/accessor/innovations/innovation01/record`,
      },
      {
        title: 'Action tracker',
        link: `/accessor/innovations/innovation01/action-tracker`,
        key: 'ACTION',
      },
      {
        title: 'Comments',
        link: `/accessor/innovations/innovation01/comments`,
        key: 'COMMENT',
      },
      {
        title: 'Support status',
        link: `/accessor/innovations/innovation01/support`,
        key: 'SUPPORT',
      },
      {
        title: 'Activity log',
        link: `/accessor/innovations/innovation01/activity-log`,
      },
    ];
  ...
  it('should have leftSideBar with "emptyLeftAside" menu values', () => {
    activatedRoute.snapshot.data = {
      layoutOptions: { type: 'emptyLeftAside' },
    };
    authenticationStore.isValidUser = () => true;
