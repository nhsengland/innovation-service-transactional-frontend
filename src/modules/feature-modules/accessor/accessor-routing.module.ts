  ...
  menuBarItems: {
    left: [
      ...
      { id: 'actions', label: 'Actions', url: '/accessor/actions' },
      {
        id: 'notifications',
        label: 'Notifications',
        url: '/accessor/notifications',
      },
      {
        id: 'account',
        label: 'Your account',
        url: '/accessor/account/manage-details',
      },
    ],
    right: [],
  },
...

                  {
                    ...
                    children: [
                      ...
                      },
                      {
                        path: 'new',
                        pathMatch: 'full',
                        component: PageInnovationExportRequestNewComponent,
                      },
                      {
                        path: ':requestId',
                        pathMatch: 'full',
...

              {
                ...
                children: [
                  ...
                  },
                  {
                    path: 'new',
                    pathMatch: 'full',
                    component: PageInnovationActionTrackerNewComponent,
                    data: { breadcrumb: 'New' },
                  },
                  {
                    path: ':actionId',
                    ...
                    children: [
                      ...
                      },
                      {
                        path: 'edit',
                        pathMatch: 'full',
                        component: PageInnovationActionTrackerEditComponent,
                        data: { breadcrumb: 'Edit' },
                      },
                      {
                        path: 'cancel',
                        pathMatch: 'full',
                        component: PageInnovationActionTrackerCancelComponent,
...

      {
        ...
        children: [
          ...
          },
          {
            ...
            pathMatch: 'full',
            component: PageActionsAdvancedSearchComponent,
          },
        ],
      },
