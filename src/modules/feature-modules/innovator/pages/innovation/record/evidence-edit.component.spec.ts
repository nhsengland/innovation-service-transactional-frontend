...
describe('FeatureModules/Innovator/Pages/Innovations/Sections/InnovationsSectionEvidenceEditComponent', () => {
  ...
  it('should run onSubmitStep() and redirect to next step', () => {
    ...
    component.onSubmitStep('next', new Event(''));
    expect(routerSpy).toHaveBeenCalledWith(['/innovator/innovations/Inno01/record/sections/EVIDENCE_OF_EFFECTIVENESS/evidence/new/2'], {});
  ...
  it('should run getNavigationUrl() for first step when pressing PREVIOUS and evidence EDITING', () => {
    ...
    expect(component.getNavigationUrl('previous')).toBe('/innovator/innovations/Inno01/record/sections/EVIDENCE_OF_EFFECTIVENESS/evidence/evidenceId01');
  ...
  it('should run getNavigationUrl() for summary step when pressing PREVIOUS', () => {
    ...
    expect(component.getNavigationUrl('previous')).toBe(`/innovator/innovations/Inno01/record/sections/EVIDENCE_OF_EFFECTIVENESS/evidence/new/3`);
  ...
  it('should run getNavigationUrl() for a question step when pressiong PREVIOUS', () => {
    ...
    expect(component.getNavigationUrl('previous')).toBe('/innovator/innovations/Inno01/record/sections/EVIDENCE_OF_EFFECTIVENESS/evidence/new/1');
  ...
  it('should run getNavigationUrl() for summary step when pressing NEXT and evidence CREATION', () => {
    ...
    expect(component.getNavigationUrl('next')).toBe('/innovator/innovations/Inno01/record/sections/EVIDENCE_OF_EFFECTIVENESS/evidence/new/summary');
  ...
  it('should run getNavigationUrl() for summary step when pressing NEXT and evidence EDITING', () => {
    ...
    expect(component.getNavigationUrl('next')).toBe('/innovator/innovations/Inno01/record/sections/EVIDENCE_OF_EFFECTIVENESS/evidence/evidenceId01/edit/summary');
  ...
  it('should run getNavigationUrl() for a question step when pressiong NEXT and evidence CREATION', () => {
    ...
    expect(component.getNavigationUrl('next')).toBe('/innovator/innovations/Inno01/record/sections/EVIDENCE_OF_EFFECTIVENESS/evidence/new/3');
  ...
  it('should run getNavigationUrl() for a question step when pressiong NEXT and evidence EDITING', () => {
    ...
    expect(component.getNavigationUrl('next')).toBe('/innovator/innovations/Inno01/record/sections/EVIDENCE_OF_EFFECTIVENESS/evidence/evidenceId01/edit/3');
