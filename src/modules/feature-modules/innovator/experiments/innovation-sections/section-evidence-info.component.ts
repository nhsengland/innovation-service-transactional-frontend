...
@Component({
  selector: 'app-innovator-experiments-innovation-section-evidence-info',
  templateUrl: './section-evidence-info.component.html'
})
export class ExperimentsInnovationSectionEvidenceInfoComponent extends CoreComponent implements OnInit {
