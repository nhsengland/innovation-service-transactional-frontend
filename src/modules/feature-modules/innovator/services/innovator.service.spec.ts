...
describe('FeatureModules/Innovator/InnovatorService', () => {
  ...
  it('should run transferInnovation() and return success', () => {
    ...
    let response: any = null;
    service.transferInnovation({ innovationId: 'Inno01', email: 'some@email.com', isCollaborator: false }).subscribe({ next: success => response = success, error: error => response = error });
