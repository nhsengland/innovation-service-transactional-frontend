      ...
      subSections: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              description: "Provide a high-level overview of your innovation. You will have the opportunity to explain its impact, target population, testing and revenue model later in the innovation record.",
              lengthLimit: "s",
              validations: {
            ...
            },
            {
              ...
              description: "<p>If your head office is overseas but you have a UK office, use the UK address.</p><p>If you are not part of a company or organisation, put where you are based.</p><p>We ask this to identify the organisations and people who are in the best position to support you.</p>",
              validations: {
            ...
            },
            {
              ...
              description: "<p>For example, support with clinical trials, product development, real-world evidence, regulatory advice, or adoption.</p><p>You will have the opportunity to explain how your innovation works and its benefits later in the record</p>",
              lengthLimit: "xl",
              validations: {
                isRequired: "A description is required"
              }
      ...
      subSections: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  label: "Changes delivery of care from secondary care(for example hospitals) to primary care(for example GP or community services)",
                  group: "Benefits for the NHS and social care"
                },
                {
            ...
            },
            {
              ...
              description: "<p>All NHS suppliers will be expected to provide the carbon footprint associated with the use of their innovation, as outlined in the <a href={{URLS.DELIVERING_A_NET_ZERO_NHS}} target=\"_blank\" rel=\"noopener noreferrer\">Delivering a Net Zero NHS report (opens in a new window)</a>.</p><p>If this is something you are unsure of, the NHS Innovation Service can support you with this.</p>",
              validations: {
                isRequired: "Choose one option"
              },
              items: [
        ...
        },
        {
          ...
          questions: [
            ...
            },
            {
              ...
              condition: "data.innovationPathwayKnowledge != 'dontKnow' and data.innovationPathwayKnowledge != 'notPartPathway'"
            }
          ]
        }
      ]
      ...
      subSections: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              description: "This can include any testing you have done with people who would use your innovation, for example patients, nurses or administrative staff.",
              field: {
                id: "kind",
                dataType: "text",
                label: "User test",
        ...
        },
        {
          ...
          questions: [
            ...
            },
            {
              ...
              description: "Find out more about <a href={{URLS.INNOVATION_GUIDES_INTELLECTUAL_PROPERTY}} target=\"_blank\" rel=\"noopener noreferrer\">intellectual property (opens in a new window)</a>.",
              validations: {
                isRequired: "Choose one option"
              },
              items: [
      ...
      subSections: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              condition: "data.hasRevenueModel != 'no' and data.hasRevenueModel != 'dontKnow' and data.hasFunding != 'no' and data.hasFunding != 'notRelevant'"
            }
          ]
        }
      ]
      ...
      subSections: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              description: "<p>Include the relevant metric such as a flat capital cost or cost per patient, cost per unit or cost per procedure. Include any costs associated with implementation and resources.</p><p>For example, £10 based on 500 units per site. £345 per procedure and a typical patient requires two procedures.</p>",
              lengthLimit: "m",
              validations: {
                isRequired: "A description is required"
              },
            ...
            },
            {
              ...
              description: "<p>For example, users need to be over a certain age, or have a certain medical history or current health status.</p><p>Answer \"not relevant\" if your innovation does not have any eligibility criteria.</p>",
              lengthLimit: "m",
              validations: {
                isRequired: "A description is required"
              },
