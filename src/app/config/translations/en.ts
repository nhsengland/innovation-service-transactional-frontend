      ...
      catalog: {
        innovation: {
          ...
          notification_context_details: {
            ...
            NEEDS_ASSESSMENT_SUGGESTED_ORGS_NOT_SHARED: { title: `One or more organisations have been suggested to support "{{ innovationName }}" but are not able to view it because you have not agreed to share with them.` },
