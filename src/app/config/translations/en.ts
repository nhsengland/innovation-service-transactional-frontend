      ...
      catalog: {
        ...
        innovation: {
          ...
          notification_context_details: {
            ...
            SH03_INNOVATION_STOPPED_SHARED_TO_SELF: { title : `You have stopped sharing innovation {{innovationName}} with all support organisations and the needs assessment team.`},
